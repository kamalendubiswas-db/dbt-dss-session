...
origin_airport_codes as (
    ...
    FROM {{ref("airport_codes_classic")}}
...
airline_names as (
    ...
    SELECT iata, name as airline_name FROM {{ ref('airline_codes_classic') }}
),
...
bronze_data as (
    ...
    FROM {{ref("airline_trips_bronze_classic")}}
),
